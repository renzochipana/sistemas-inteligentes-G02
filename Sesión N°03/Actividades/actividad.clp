...
(defrule determine-low-output ""
   ...
   (not (repair ?))
   =>
   (assert (engine-output-low (yes-or-no-p "Is the output of the engine low (yes/no)? "))))
...
(defrule determine-gas-level ""
   ...
   (not (repair ?))
   =>
   (assert (tank-has-gas (yes-or-no-p "Does the tank have any gas in it (yes/no)? "))))

(defrule determine-battery-state ""
   (engine-rotates no)
   (not (repair ?))
   =>
   (assert (battery-has-charge (yes-or-no-p "Is the battery charged (yes/no)? "))))
...
(defrule determine-point-surface-state ""
   ...
   (not (repair ?))
   =>
   (assert (point-surface-state (ask-question "What is the surface state of the points (normal/burned/contaminated)? " normal burned contaminated))))
...
(defrule determine-conductivity-test ""
   ...
   (not (repair ?))
   =>
   (assert (conductivity-test-positive (yes-or-no-p "Is the conductivity test for the ignition coil positive (yes/no)? "))))
